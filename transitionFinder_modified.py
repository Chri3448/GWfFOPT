...
import pathDeformation_modified
import tunneling1D_modified
...
def _tunnelFromPhaseAtT(T, phases, start_phase, V, dV,
    ...
    for tdict in tunnel_list:
        ...
        try:
            ...
            print('full tunneling params = ', fullTunneling_params)
            tobj = pathDeformation_modified.fullTunneling(
            ...
            tdict['trantype'] = 1
        except tunneling1D_modified.PotentialError as err:
